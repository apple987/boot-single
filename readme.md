...
#### 项目介绍
boot-single是[boot-master](https://gitee.com/bootstrap2table/boot_master)配置简化版，默认配置下，用户仅需要自己配置单机mysql和redis组件，就可以使用[boot-master](https://gitee.com/bootstrap2table/boot_master)版本的功能。<br>
